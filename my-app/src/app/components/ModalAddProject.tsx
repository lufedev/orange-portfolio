...
export default function ModalAddProject({ project, states, onClose }: ProjectProps) {
    ...
    return (
        ...
        >
            <Box sx={{
                ...
                <Typography id="modal-modal-title" className="text-color-neutral-110 w-4/5 text-left" variant="h5" component="h2">
                    Adicionar projeto
                </Typography>
                    ...
                    <div className="w-full md:w-1/2 flex flex-col justify-center items-center gap-8">
                        ...
                        <div className="rounded w-full md:w-[100%] h-[100%] text-lowercase w-327 h-330 flex flex-col space-y-4 justify-center items-center">
                            {isUrlImage ? (
                                ...
                                <Button component="label" disableElevation variant="contained" className="w-[100%] h-[80%] bg-color-neutral-70 hover:bg-color-neutral-70 flex flex-col justify-center items-center text-color-neutral-120 font-normal normal-case">
                                    <PhotoLibraryIcon className="text-5xl" />
                                    <p className="w-[80%]">Compartilhe seu talento com milhares de pessoas</p>
